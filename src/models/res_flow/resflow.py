...
import res_flow.layers as layers
import res_flow.layers.base as base_layers
from res_flow.utils import ExponentialMovingAverage
...
def get_res_flow_optimizer(args, model):
    return optim.Adam(model.parameters(), lr=args.lr, betas=(0.9, 0.99), weight_decay=args.wd)


def get_residual_flow_by_args(args, data_shape):
    return ResidualFlow(
        data_shape,
...
class ResidualFlow(nn.Module):
    ...
    def __init__(
        ...
        **dummy_kwargs
        ...
        #### David:
        self.ema = ExponentialMovingAverage(self)
